...
(pair-sum-lazy? (gen-lazy-list 1 10) 1000) ; #f
(pair-sum-lazy? (gen-lazy-list 1 3) 3) ; #t
...
; (check-equal? (any-sum-lazy? (gen-lazy-list 1 10) 1000) #f)
; (check-equal? (any-sum-lazy? (gen-lazy-list 1 3) 3) #t)
(any-sum-lazy? (gen-lazy-list 1 10) 1000) ; #f
(any-sum-lazy? (gen-lazy-list 1 3) 3) ; #t
